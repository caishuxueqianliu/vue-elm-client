<template>
 <div class="shop_container" >
            <ul class="shop_list" v-if="shops.length">
              <li class="shop_li border-1px" v-for="(shop,index) in shops" :key="index" @click="goTo()">
                <a>
                  <div class="shop_left">
                   <!-- <img class="shop_img" :src="baseImgUrl+shop.image_path"> -->
  <!-- <img class="shop_img" :src="shop.image_path"> -->
    <img class="shop_img" src="http://elm.cangdu.org/img/164ad0b6a3917599.jpg">
